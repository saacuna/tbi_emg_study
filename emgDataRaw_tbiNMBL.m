classdef emgDataRaw_tbiNMBL < handle
    ...
    methods ( Access = public )
        ...
        function saveEmgData(obj)
            % this function saves all the emg data as a .mat file of this
            % class, for easier access. Includes raw and cycle emg data
            
            % create save file name
            tbiNum_index = regexp(obj.subjectID, '\d');
            defaultFilename = ['emgRaw_tbi' obj.subjectID(tbiNum_index) '_tp' obj.testPoint '_' obj.trialType '.mat'];
