...
a1 = patch([x; x(end:-1:1)],[z2; z1(end:-1:1)],[0.7 0.7 0.7]); set(a1,'LineStyle','none'); % area(x,z1,min(YLIM)); 
hold on;
p = plot(x,y); set(p,'LineWidth',1,'Color',[0 0 0]); %p = plot(x,y,x,z1,x,z2);    YLIM = get(gca,'YLim');    delete(p);
